# Project's struct
- `avl_tree.h`: Definition of the pointer "tree", the type of data stored and function prototypes.
- `avl_tree.c`: Definition of the data type "tree" and implementation of the functions.
	- `main.c`: Management of the user interface and input/output (I/O) operations.
- `avl_tree_test.c`: Implementation of the test functions.
	- `main_test.c`: Unitary test for validate the creation and manipulation.


The purpose of this project is to learn the applications of avl tree.
...
• Balanced trees: It's a binary tree in which the left and right subtrees height from each node differ by at most one . This difference is called the node "balance factor" 
