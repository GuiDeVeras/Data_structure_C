	...
	while (i != 0) {
		...
		switch (i) {
			...
			case 8:
				printf("\nPosition: ");
				scanf("%d", &position);
				if (consult_pos(list, position) != 0) {
					printf("The element of the position %d is %d\n\n", position, consult_pos(list, position));
				} else {
