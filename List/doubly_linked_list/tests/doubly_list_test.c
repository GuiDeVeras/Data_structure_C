...
void test_insert_elem_begin() {
	...
	assert((*list)->next->previous->value == 2);
	...
	assert((*list)->next->previous->value == 3);
	assert((*list)->next->next->value == 1);
	assert((*list)->next->next->previous->value == 2);
...
void test_insert_elem_end() {
	...
	assert((*list)->previous == NULL);
	assert((*list)->next->value == 2);
	assert((*list)->next->previous->value == 1);
	assert((*list)->next->next == NULL);
	assert(list_size(list) == 2);
...
void test_remove_elem_end() {
	...
	remove_elem_end(list);
	assert((*list)->value == 4);
	assert((*list)->next->previous->value == 4);
	assert((*list)->next->value == 3);
	assert((*list)->next->next == NULL);
	assert(list_size(list) == 2); 
...
void test_consult_elem_pos() {
	...
	assert(consult_elem_pos(list, 4) == 0);
	
	insert_elem_end(list, 3);
	assert(consult_elem_pos(list, 1) == 0);
	
	assert(consult_elem_pos(list, 3) == 1);
	
	insert_elem_end(list, 2);
	assert(consult_elem_pos(list, 2) == 2);
